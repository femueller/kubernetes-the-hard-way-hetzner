...
for instance in controller-0 controller-1 controller-2; do
  ...
  scp -o StrictHostKeyChecking=no ca.pem kubernetes-key.pem kubernetes.pem root@$external_ip:.
...
ExecStart=/usr/local/bin/etcd \\
  ...
  --initial-cluster-token etcd-clucster-0 \\
  --initial-cluster controller-0=c,controller-1=https://10.240.0.11:2380,controller-2=https://10.240.0.12:2380 \\
